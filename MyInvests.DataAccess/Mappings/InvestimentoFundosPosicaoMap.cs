...
{
    public class InvestimentoFundosPosicaoMap : EntityTypeConfiguration<InvestimentoFundosPosicao>
    {
        public InvestimentoFundosPosicaoMap()
        {
            ToTable("TBINV_FundosPosicao");
            ...
            Property(x => x.ValorPorQuota).HasColumnName("VLR_POR_UNID").IsRequired();
